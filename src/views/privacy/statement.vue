...
<template>
  <h1>《基于穿戴设备收集数据》隐私政策</h1>
  <div>更新日期：<strong>2024/9/3</strong></div>
  <div>生效日期：<strong>2024/9/3</strong></div>
  <h2>导言</h2>
  <p>
    <i>基于华为智能手环9采集数据系统</i> 是一款由 <i>许家豪</i> （以下简称“我们”）提供的产品。
  ...
  <p>如对本《隐私政策》或相关事宜有任何问题，请通过 <strong>1860391926</strong> 与我们联系。</p>
